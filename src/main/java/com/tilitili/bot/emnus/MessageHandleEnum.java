...
public enum MessageHandleEnum {
	...
	CalendarHandle(				"CalendarHandle",					Arrays.asList("日程表","rc"),			0,		Arrays.asList(FRIEND_MESSAGE, TEMP_MESSAGE, GROUP_MESSAGE)),
	DeleteCalendarHandle(		"DeleteCalendarHandle",			Arrays.asList("移除日程"),				0,		Arrays.asList(FRIEND_MESSAGE, TEMP_MESSAGE, GROUP_MESSAGE)),
