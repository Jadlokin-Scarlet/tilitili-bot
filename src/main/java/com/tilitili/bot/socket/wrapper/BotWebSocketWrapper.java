...
@Slf4j
public class BotWebSocketWrapper implements BotWebSocketWrapperImp {
	...
	public BotWebSocketWrapper(Long botId, BotManager botManager, BotService botService, BotRobotCacheManager botRobotCacheManager) {
		this.botId = botId;
	...
	public void upBotBlocking() {
		...
		try {
			...
			handler = new BotWebSocketHandler(new URI(wsUrl), bot, botService, botRobotCacheManager);
