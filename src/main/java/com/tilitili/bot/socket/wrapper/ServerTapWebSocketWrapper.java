...
import com.tilitili.bot.socket.handle.ServerTapWebSocketHandler;
...
@Slf4j
public class ServerTapWebSocketWrapper implements BotWebSocketWrapperImp {
	private final Long botId;
	private final BotManager botManager;
	private final BotService botService;
	private final BotRobotCacheManager botRobotCacheManager;
	private ServerTapWebSocketHandler handler;
	private final AtomicBoolean blocking = new AtomicBoolean(false);


	public ServerTapWebSocketWrapper(Long botId, BotManager botManager, BotService botService, BotRobotCacheManager botRobotCacheManager) {
		this.botId = botId;
	...
	public void upBotBlocking() {
		...
		try {
			...
			handler = new ServerTapWebSocketHandler(wsRequest, bot, botManager, botService, botRobotCacheManager);
