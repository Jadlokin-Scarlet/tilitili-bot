...
//
//    @Autowired
//    public MiraiService(List<BaseMessageHandle> messageHandleList, ResourcesManager resourcesManager, MiraiManager miraiManager, BotSessionService botSessionService) {
...
//                BotSessionService.MiraiSession miraiSession = botSessionService.getSession("group-" + sender);
//                result = handleGroupMessage(miraiMessage, miraiSession);
//            } else {
//                Long sender = miraiMessage.getSender().getId();
//                BotSessionService.MiraiSession miraiSession = botSessionService.getSession("friend-" + sender);
...
//    }
//
//    public BotMessage handleGroupMessage(MiraiMessageView message, BotSessionService.MiraiSession miraiSession) {
//        try {
...
//    }
//
//    public BotMessage handleMessage(MiraiMessageView message, BotSessionService.MiraiSession miraiSession) {
//        try {
