...
import com.tilitili.common.entity.view.bot.mirai.event.KookDeletedMessage;
...
@Slf4j
@Component
public class KookDeletedMessageHandle extends KookAutoEventHandle<KookDeletedMessage> {
	...
	@Autowired
	public KookDeletedMessageHandle(BotSenderMapper botSenderMapper, BotMessageRecordMapper botMessageRecordMapper, BotManager botManager, BotSendMessageRecordMapper botSendMessageRecordMapper) {
		super(KookDeletedMessage.class);
	...
	public void handleEvent(BotEmum bot, KookDeletedMessage event) throws Exception {
		...
		BotMessageRecord messageRecord = botMessageRecordMapper.getBotMessageRecordByMessageId(event.getMsgId());
