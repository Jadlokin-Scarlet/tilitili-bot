...
public class ChatHandle extends ExceptionRespMessageHandle {
	...
	public BotMessage handleMessage(BotMessageAction messageAction) throws Exception {
		...
		String respStr = HttpClientUtil.httpGet("http://api.qingyunke.com/api.php?key=free&appid=0&msg=" + req);
		...
		return BotMessage.simpleTextMessage(resp.getString("content"));
	}
}
