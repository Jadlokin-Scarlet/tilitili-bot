...
import com.tilitili.common.entity.view.bot.mirai.event.GocqNoticeFriendRecall;
...
@Slf4j
@Component
public class GocqNoticeFriendRecallHandle extends GocqAutoEventHandle<GocqNoticeFriendRecall> {
	...
	@Autowired
	public GocqNoticeFriendRecallHandle(BotSenderMapper botSenderMapper, BotMessageRecordMapper botMessageRecordMapper, BotManager botManager, BotSendMessageRecordMapper botSendMessageRecordMapper) {
		super(GocqNoticeFriendRecall.class);
	...
	@Override
	public void handleEvent(BotEnum bot, GocqNoticeFriendRecall event) throws Exception {
		BotSender botSender = botSenderMapper.getValidBotSenderByQq(event.getUserId());
