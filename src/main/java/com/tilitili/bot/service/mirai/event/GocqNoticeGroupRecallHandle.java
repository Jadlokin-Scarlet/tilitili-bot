...
import com.tilitili.common.entity.view.bot.mirai.event.GocqNoticeGroupRecall;
...
@Slf4j
@Component
public class GocqNoticeGroupRecallHandle extends GocqAutoEventHandle<GocqNoticeGroupRecall> {
	...
	@Autowired
	public GocqNoticeGroupRecallHandle(BotSenderMapper botSenderMapper, BotMessageRecordMapper botMessageRecordMapper, BotManager botManager, BotSendMessageRecordMapper botSendMessageRecordMapper) {
		super(GocqNoticeGroupRecall.class);
	...
	@Override
	public void handleEvent(BotEmum bot, GocqNoticeGroupRecall event) throws Exception {
