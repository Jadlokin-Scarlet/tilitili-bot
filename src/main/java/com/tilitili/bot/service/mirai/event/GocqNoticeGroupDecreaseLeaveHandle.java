...
public class GocqNoticeGroupDecreaseLeaveHandle extends GocqAutoEventHandle<GocqNoticeGroupDecreaseLeave> {
	...
	@Autowired
	public GocqNoticeGroupDecreaseLeaveHandle(BotSenderMapper botSenderMapper, SendMessageManager sendMessageManager, BotUserManager botUserManager, BotUserSenderMappingMapper botUserSenderMappingMapper) {
