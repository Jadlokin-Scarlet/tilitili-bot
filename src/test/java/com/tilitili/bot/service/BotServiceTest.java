...
public class BotServiceTest {
	...
	public void syncHandleTextMessage() {
		...
		tester.testHandleMessage(bot, "{\"player\":{\"uuid\":\"ccb182ef-08d0-33f0-85af-ac4d7b4f3e52\",\"displayName\":\"§bJS§r\",\"port\":9272,\"exhaustion\":2.4730031,\"exp\":0.0,\"whitelisted\":false,\"banned\":false,\"op\":false,\"balance\":1.0},\"playerName\":\"§bJS§r\",\"message\":\"kook\",\"eventType\":\"PlayerChat\"}");
